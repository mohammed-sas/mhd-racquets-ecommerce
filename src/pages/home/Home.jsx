                ...
                <div className="new-arrival-container">
                    <div className="card-container  bg-purple-50 card-width-40 padding-1rem">
                        <div className="horizontal-card">
                            ...
                            <div className="card-heading">
                                <div className="padding-l-r-16-b-5 heading bg-purple-50">Gold medal Limited Edition</div>
                                <div className="padding-l-r-16-b-5 sub-heading bg-purple-50">by LI-NING</div>
                            </div>
                        </div>
                    ...
                    <div className="card-container  bg-purple-50 card-width-40 padding-1rem">
                        <div className="horizontal-card">
                            ...
                            <div className="card-heading  ">
                                <div className="padding-l-r-16-b-5 heading bg-purple-50">Aeronaut 4000 boost</div>
                                <div className="padding-l-r-16-b-5 sub-heading bg-purple-50">by LI-NING</div>
                            </div>
                        </div>
